...
const V2LoginPage: React.FC = () => {
  ...
  const handleLocalSubmit = (e: React.FormEvent) => {
      ...
      login({ id: 'local-user', username, tmdb_key: localKey, is_cloud: false });
  };
              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
                  <div className="bg-zinc-900 border border-zinc-800 w-full max-w-sm rounded-3xl p-6 shadow-2xl animate-enter">
                      ...
                      <div className="flex gap-3">
                          ...
                          {/* importBackup is not in minimal store, assume unimplemented for now or fix later */}
                          <button onClick={() => { setImportPreview(null); }} className="flex-1 py-3 rounded-xl bg-emerald-600 text-white font-bold hover:bg-emerald-500">Restore</button>
                      </div>
                  </div>
              </div>
          )}
